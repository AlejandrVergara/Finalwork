---
title: "Final Work"
author: "Alejandro Vergara Rincon 81190-Jennyfer Torres 84031"
date: "2023-11-13"
output:
...
-   Decision Tree structure is presented, but specific metrics are not
    available.

### **Random Forest:**

-   **Accuracy:** 100% (Note: This may indicate overfitting, as perfect
    accuracy is unusual)
...
-   Random Forest achieved perfect accuracy, but this might be a result
    of overfitting.

-   SVM with the radial kernel performed very well with high accuracy,
    sensitivity, specificity, and precision.

-   k-NN and linear regression, while respectable, did not outperform
    SVM in terms of accuracy and other metrics.
